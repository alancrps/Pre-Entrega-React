			...
			<Container fluid>
				...
				<Navbar.Collapse id="navbar-nav" className="justify-content-end">
					<Nav className="align-items-center">
						...
						<Nav.Link as={Link} to="/productos" className="navlink mx-2">
							Productos
						</Nav.Link>
						{/* <Nav.Link as={Link} to="/oferta" className="navlink mx-2">
							En Oferta
						</Nav.Link> */}
						<Nav.Link as={Link} to="/contacto" className="navlink mx-2">
							Contacto
						</Nav.Link>
                        <Nav.Link as={Link} to="/carrito" className="text-dark mx-2">
