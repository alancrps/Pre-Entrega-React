...
export default function Footer() {
	...
	return (
		<footer style={{ backgroundColor: 'white', padding: '40px 0' }} className="custom-font">
			<Container fluid>
							...
							<Col md={6} className="mb-3">
								...
								<ul style={{ listStyle: 'none', padding: 0 }}>
									<li className="d-flex align-items-center mb-3">
										<FontAwesomeIcon
											icon={faWhatsapp}
											style={{ marginRight: '8px', color: redColor, fontSize: '1.5rem' }}
										/>
										WhatsApp
									</li>
									<li className="d-flex align-items-center mb-3">
				...
				<hr />
				<p className="text-center mb-0">© 2025 BIKECORPS. Todos los derechos reservados.</p>
			</Container>
		</footer>
	);
}
